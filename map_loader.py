# -*- coding: utf-8 -*-
"""
Created on Fri Mar 13 14:59:58 2020

@author: Hefke
"""

class loader(object):
    def __init__(self, mapfile, tileset):
        self.mapfile = open(mapfile & '.tmx', 'r').readlines()
        self.tileset = open(tileset & '.tsx', 'r').readlines()
...
class TiledMap():
    ...
    def __init__(self, mapstring):
        self.gameMap = pytmx.load_pygame("grass_map.tmx", pixelalpha=True)
